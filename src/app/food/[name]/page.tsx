...
const FoodPage = ({ params }: { params: { name: string } }) => {
  ...
  const COLORS = ["#F28907", "#5079F2", "#660033", "#e1f3ab"];
          ...
          <div className="flex flex-col md:flex-row items-center md:items-start">
            <div className="w-full md:w-1/2 lg:w-1/3 mb-8 md:mb-0">
              ...
              <div className="text-center mt-4">
                ...
                Protéine
                <span className="inline-block w-3 h-3 bg-[#660033] ml-4 mr-2"></span>{" "}
                Gras
                <span className="inline-block w-3 h-3 bg-[#e1f3ab] ml-4 mr-2"></span>{" "}
                Fibre
              </div>
            </div>
            <div className="w-full md:w-1/2 lg:w-2/3">
              ...
              <div className="mb-4 p-4 bg-gray-900 text-white rounded-lg shadow-inner">
                <div className="flex items-center mb-2">
                  <div className="w-5 h-5 bg-[#e1f3ab] border border-gray-700 mr-3"></div>
                  <div>
                    Fibre: <span className="font-medium">{food.fiber} g</span>
                  </div>
                </div>
                <div className="flex items-center mb-2">
                ...
                <div className="flex items-center mb-2">
                  <div className="w-5 h-5 bg-[#660033] border border-gray-700 mr-3"></div>
                  <div>
                    Gras: <span className="font-medium">{food.fat}g</span>
                  </div>
                </div>
              </div>
              <div className="mt-4">
                ...
                <div className="flex items-center">
                  <Image
                    src="/flying cup of coffee.png"
                    width={30}
                    height={30}
                    alt="Minerals"
                  />
                  <div className="ml-3">
                    <span className="font-semibold">Minérales:</span>{" "}
                    {food.minerals?.join(", ")}
                  </div>
                </div>
              </div>
